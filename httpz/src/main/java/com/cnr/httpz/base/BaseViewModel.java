...
import com.cnr.httpz.bus.event.SingleLiveEvent;
...
//    }
    ...
    public void showDialog() {
        showDialog(getApplication().getResources().getString(R.string.load_Is_in_loading));
    }
    ...
    public void onErrorDialog(String massage) {
        uc.showErrorEvent.setValue(massage);
    }
    /**
     * 跳转页面
     *
